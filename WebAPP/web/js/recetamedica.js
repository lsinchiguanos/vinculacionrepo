...
function tabla(parametroUno, parametroDos)
{
    ...
    filaMetodo = '<tr class="selected" id="fila' + aumento + '" onclick=""><td>' + aumento + '</td><td>' + parametroUno + '</td><td>' + parametroDos + '</td><td>' + "   <input type='button' class='agre' value='Modificar' onclick='modificar(" + aumento + ")'>" + '</td><td>' + "<button class='elimar' onclick='eliminar(" + aumento + ")'>Eliminar</button>" + '</td></tr>';
